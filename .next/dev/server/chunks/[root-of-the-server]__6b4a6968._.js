...
async function GET(req) {
    ...
    if (apiKey !== ADMIN_KEY) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Unauthorized'
    }, {
        status: 401
    });
    try {
        const schedules = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$RoundSchedule$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).sort({
            round: 1
        });
...
async function POST(req) {
    ...
    try {
        ...
        // Expecting { schedules: [{ round: 1, description: "..." }, ...] }
        if (body.schedules && Array.isArray(body.schedules)) {
            for (const s of body.schedules){
                await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$RoundSchedule$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
                    round: s.round
                }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6b4a6968._.js.map
...
import { Code2, Feather, Palette, CalendarCheck, ArrowRight, Video, Briefcase } from 'lucide-react';
...
const getSvgForDomain = (colorClass: string, index: number) => {
    if (index === 0) { // Web Dev
        ...
        return <svg width="300" height="300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="0.5" className={colorClass}><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>;
    } else if (index === 4) { // Event
        ...
        return <svg width="300" height="300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="0.5" className={colorClass}><path d="M3 21h18"/><path d="M5 21v-7"/><path d="M9 21v-11"/><path d="M13 21v-14"/><path d="M17 21v-10"/></svg>;
    }
};
